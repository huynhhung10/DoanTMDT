...
namespace DoanTMDT.Server.Services.CartService
{
    public class CartService : ICartService
    {
        ...
        public async Task<ServiceResponse<List<CartProductResponse>>> GetCartProducts(List<CartItem> cartItems)
        {
            ...
            foreach (var item in cartItems)
            {
                ...
                var cartProduct = new CartProductResponse
                {
                    ...
                    Edition = productVariant.Edition.Name,
                    EditionId = productVariant.EditionId,
        ...
        public async Task<ServiceResponse<bool>> UpdateQuantity(CartItem cartItem)
        {
            var dbCartItem = await _context.CartItems
                .FirstOrDefaultAsync(ci => ci.ProductId == cartItem.ProductId &&
                ci.EditionId == cartItem.EditionId && ci.UserId == _authService.GetUserId());
            if (dbCartItem == null)
            {
        ...
        public async Task<ServiceResponse<bool>> RemoveItemFromCart(int productId, int editionId)
        {
            var dbCartItem = await _context.CartItems
